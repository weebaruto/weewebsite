...
Every product exists to help someone move from a **current state** (struggle, inefficiency, uncertainty)
to a **desired state** (confidence, control, simplicity).
...
The clearer we are about what someone is trying to accomplish, the simpler the product becomes.
